...
const Create = () => {
  ...
  <form action="#" method="post" encType="multipart/form-data">
    ...
    <div className="mb-4">
      ...
      <input type="number" id="number" name="number" className="w-full p-2 border rounded-md" required/>
    </div>
    <div className="mb-4">
      <label htmlFor="picture" className="block font-semibold mb-1">Upload Picture:</label>
      <input type="file" id="picture" name="picture" className="w-full p-2 border rounded-md" accept="image/*" required/>
    </div>
  ...
  <button className="bg-sky-800 text-white font-semibold py-2 px-4 hover:bg-cyan-700 cursor-pointer mt-4 w-full p-2 border rounded-md">Create</button>
</div>
